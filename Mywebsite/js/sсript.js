...
colo_l.addEventListener('mouseenter', function (createStyle)
{
    ...
    centr_l.style.backgroundImage = 'radial-gradient(circle at 53px -20px, rgba(0, 0, 0, 0) 0, rgba(0, 0, 0, 0) 60px, rgb(5,55,105) 61px)';
...
colo_r.addEventListener('mouseenter', function (createStyle)
{
    ...
    centr_r.style.backgroundImage = 'radial-gradient(circle at 53px -20px, rgba(0, 0, 0, 0) 0, rgba(0, 0, 0, 0) 60px, rgb(5,55,105) 61px)';
